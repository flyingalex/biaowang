    ...
    <div action="" class="login-form-wrap">
        ...
        <form action="" class="login-form">
            <div class="username-wrap input-wrap">
                <input type="text" class="username-input input-area" id="username-input" placeholder="用户名"><!--
            ...
            <div class="password-wrap input-wrap">
                <input type="password" class="password-input input-area" id="password-input" placeholder="密码"><!--
            ...
            <div class="captcha-wrap input-wrap">
                ...
                <input type="text" class="captcha-input input-area" id="captcha-input">
...
<script type="text/javascript" src="/lib/scripts/jquery.placeholder.min.js"></script>
-->
</body>
